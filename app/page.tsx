...
export const metadata: Metadata = {
  title: {
    absolute: "千葉・船橋 ホームページ制作｜格安10万円〜のWebデザイン会社【イロドリ】",
  },
  description:
    "千葉・船橋のホームページ制作会社イロドリ。千葉のホームページ制作を格安10万円〜でご提供。WordPress・SEO設計・コーポレートサイト制作まで一気通貫で対応。中小企業・個人事業主のホームページ制作はお気軽にご相談ください。",
  ...
  twitter: {
    ...
    title: "千葉・船橋 ホームページ制作｜格安10万円〜のWebデザイン会社【イロドリ】",
    description:
      "千葉・船橋のホームページ制作会社イロドリ。千葉のホームページ制作を格安10万円〜でご提供。WordPress・SEO設計・コーポレートサイト制作まで対応。",
    images: ["/og-image.png"],
  },
