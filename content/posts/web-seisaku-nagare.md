...
<div style="display:flex;justify-content:center;margin:1.5rem 0"><img src="/web-seisaku-nagare-flow-steps.jpg" alt="Web制作の流れを示す6ステップのフロー図。ヒアリング・要件定義・デザイン・コーディング・テスト・公開の工程をアイコンと矢印で表したイラスト" width="768" height="384" /></div>
...
千葉・船橋を拠点とするweb制作会社イロドリでは、ヒアリングから公開まで一貫して対応しています。  
