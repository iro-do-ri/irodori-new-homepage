          ...
          <div className={styles.profile}>
            ...
            <div className={styles.profileBody}>
              ...
              <p className={styles.profileBio}>
                船橋商工会議所にて約5年間、地元・船橋を中心とした中小企業の経営支援に携わってきました。その中で、優れた商品や技術を持ちながらも、ホームページがない・活用できていないことにより、集客機会を逃している企業が数多くある現状を実感しました。
              </p>
              <p className={styles.profileBio}>
                こうした課題を解決するため、現在はフリーランスのWebデザイナーとして独立し、船橋・千葉エリアを中心にホームページ制作・Web集客支援を行っています。
              </p>
            </div>
          </div>
        </div>
