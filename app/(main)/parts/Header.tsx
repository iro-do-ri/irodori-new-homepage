      ...
      <header className={`${headerStyles.header} hidden sm:block`}>
        <div className={headerStyles.sidebar}>
          ...
          <div className={headerStyles.sidebarBottom}>
            <div className={headerStyles.sidebarPhoneWrap}>
              <span className={headerStyles.sidebarPhoneLabel}>お電話のお問い合わせなら</span>
              <a href="tel:08055435943" className={headerStyles.sidebarPhone}>
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" width="15" height="15" aria-hidden="true">
                  <path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07A19.5 19.5 0 0 1 4.69 12 19.79 19.79 0 0 1 1.61 3.45 2 2 0 0 1 3.6 1.25h3a2 2 0 0 1 2 1.72 12.84 12.84 0 0 0 .7 2.81 2 2 0 0 1-.45 2.11L7.91 8.8a16 16 0 0 0 6 6l.92-.92a2 2 0 0 1 2.11-.45 12.84 12.84 0 0 0 2.81.7A2 2 0 0 1 21.5 16z"/>
                </svg>
                080-5543-5943
              </a>
            </div>
