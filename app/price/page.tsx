...
export const metadata: Metadata = {
  title: "料金プラン｜千葉・船橋のホームページ制作・チラシデザイン【イロドリ】",
  description:
    "千葉・船橋のホームページ制作会社イロドリの料金プラン。ホームページ制作10万円〜、チラシ片面デザイン3万円〜・両面5万円〜。WordPress・SEO設計込み。見積もり無料でご相談ください。",
  keywords: ["千葉", "船橋", "千葉・船橋", "千葉 ホームページ制作", "料金プラン", "ホームページ制作", "チラシデザイン", "フライヤーデザイン", "格安", "WordPress", "SEO対策", "イロドリ"],
  alternates: { canonical: "https://iro-do-ri.jp/price" },
  openGraph: {
    title: "料金プラン｜千葉・船橋のホームページ制作・チラシデザイン【イロドリ】",
    description:
      "千葉・船橋のホームページ制作会社イロドリの料金プラン。ホームページ制作10万円〜、チラシ片面3万円〜・両面5万円〜。WordPress・SEO設計込み。見積もり無料。",
  ...
  twitter: {
    ...
    title: "料金プラン｜千葉・船橋のホームページ制作・チラシデザイン【イロドリ】",
    description:
      "千葉・船橋のホームページ制作・チラシデザイン料金プラン。ホームページ10万円〜、チラシ片面3万円〜・両面5万円〜。WordPress・SEO設計込み。見積もり無料。",
    images: ["/og-image.png"],
  },
